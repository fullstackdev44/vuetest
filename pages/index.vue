...
<b-card>
  ...
  <div v-if="item.favorite==0 || item.favorite == null">  <b-button variant="outline-primary"  v-on:click="greet(item.id)">Add to favorite</b-button></div>
 <div v-else="item.favorite==1"> <b-alert show variant="success">Added</b-alert> </div>
</b-card>
</div>
</b-row>
